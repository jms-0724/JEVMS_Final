...
if (isset($jsondecoded['add_journal_number'])) {
    ...
    try {
        ...
        if ($sql1->execute()) {
            ...
            logAuditTrail($conn, 'tbl_journal_entry', $last_id, 'ADD', $audit_description, $_SESSION['userid']);
            ...
            foreach ($jsondecoded['journal_array'] as $row) {
                ...
                if ($sql2->execute()) {
                    ...
                    logAuditTrail($conn, 'tbl_journal_items', $last_id3, 'ADD', $audit_description, $_SESSION['userid']);
                    ...
                    logAuditTrail($conn, 'tbl_trial_balance', $last_id4, 'ADD', $audit_description, $_SESSION['userid']);
