...
$pdf->Cell(10, 10, '', 'LTRB', 0, 'L', false);
$pdf->Cell(25, 10, 'Debit', 'LTRB', 0, 'L', false);
$pdf->Cell(25, 10, 'Credit', 'LTRB', 1, 'L', false);

$pdf->SetFont('Times', '', 12);
$total_debit = 0;
$total_credit = 0;
foreach ($resultfirst as $rowfirst) {
    $pdf->Cell(30, 6, $rowfirst['account_code'], 'LTRB', 0, 'L', false);
    $pdf->Cell(10, 6, '', 'LTRB', 0, 'L', false);
    $pdf->Cell(80, 6, $rowfirst['account_name'], 'LTRB', 0, 'L', false);
    $pdf->Cell(10, 6, '', '', 0, 'L', false);
    if($rowfirst['journal_adjustment'] === "Debit"){
        $pdf->Cell(25, 6, number_format($rowfirst['total_debit'],2), 'LTRB', 0, 'R', false);
        $pdf->Cell(25, 6, '', 'LTRB', 1, 'L', false);
        $total_debit += $rowfirst['total_debit'];
    } else {
        $pdf->Cell(25, 6, '', 'LTRB', 0, 'L', false);
        $pdf->Cell(25, 6, number_format($rowfirst['total_credit'],2), 'LTRB', 1, 'R', false);
...
$pdf->Cell(10, 6, '', 'LTRB', 0, 'L', false);
$pdf->Cell(25, 6, number_format($total_debit,2), 'LTRB', 0, 'L', false);
// $pdf->Cell(5, 6, '', 'LTRB', 0, 'L', false);
$pdf->Cell(25, 6, number_format($total_credit,2), 'LTRB', 1, 'L', false);
