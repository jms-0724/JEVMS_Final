    ...
    try {
        ...
        if ($result) {
            ...
            if ($sql3->execute()) {
                ...
                logAuditTrail($conn, 'tbl_user_info', $add_user_info_id, 'INSERT', $audit_description, $_SESSION['userid']);
                ...
                if ($sql2->execute()) {
                    ...
                    logAuditTrail($conn, 'tbl_user', $last_id, 'INSERT', $audit_description, $_SESSION['userid']);
                    echo "Success";
                    $conn->commit();
                } else {
