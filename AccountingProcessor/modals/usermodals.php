              ...
              <div class="row">
                ...
                <label for="userlevel" class="form-label">Userlevel</label>
                    <select name="add_userlevel" id="add_userlevel" class="form-select" required>
                        ...
                        <option value="Accounting Processor">Accounting Processor</option>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="add_position" id="add_position" class="form-control" required>
                </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form id="upd_user_info">
            ...
            <div class="form-group mb-2">
                    <label for="upd_position" class="form-label">Postion Name</label>
                    <input type="text" name="upd_position" id="upd_position" class="form-control" required>
                </div>
            <div class="form-group">
                <button type="submit" class="btn text-white" style="background-color:#0e2238;">Update Status</button>
                <button type="reset" class="btn text-white" style="background-color:#004d68;">Clear</button>
