...
<body>
        ...
        <h5 style="font-weight:bold; font-size:25px; text-align: left;">Journal Entry Voucher Management System</h5>
            ...
            <div class="card">
                <div class="card-header" style="background-color:#0e2238;">
                    <div class="d-flex mt-1 p-2">
                        <h3 style="font-weight:bold; color:white; font-size: 25px;"><i class="lni lni-home"></i> Signatories</h3>
                    </div>
                </div>
            ...
            <main class="card-body">
                <div class="container-fluid">
                    <div class="mb-3">
                    <div class="d-flex">
                        <button type="button" class="btn btn-primary rounded text-light" data-bs-toggle="modal" data-bs-target="#addSignatories" style="margin-right:10px; background-color:#0e2238;">Add Signatories</button>
                        <button type="button" class="btn btn-primary rounded text-light" data-bs-target="#archiveSignatory" data-bs-toggle="modal" style="margin-right:10px; background-color:#0e2238;">Update Signatory Status</button>
                        <div class="d-flex">
                        <input type="search" name="searchTypes" id="searchSignatories" class="form-control" placeholder="Search...">
                        </div>
                    </div>
                        <div class="row mt-3">
                            <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th class="text-light" style="background-color:#0e2238;">Middle Initial</th>
                                    <th class="text-light" style="background-color:#0e2238;">Firstname</th>
                                    <th class="text-light" style="background-color:#0e2238;">Position</th>
                                    <th class="text-light" style="background-color:#0e2238;">Status</th>
                                    <th class="text-light" style="background-color:#0e2238;">Signatory Date</th>
                                    <th class="text-light" style="background-color:#0e2238;">Actions</th>
                                </thead>
                                <tbody id="displaySignatories">
    ...
    <script src="./../assets/js/signatories.js"></script>


    
    <?php 
         include("./modals/logoutmodal.php");
         include("./modals/confirmsignatory.php");
         include("./modals/signatoriesmodal.php");
    ?>
