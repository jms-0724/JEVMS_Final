...
<body>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="auth2" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link" style="font-size:12px">Audit Log</a>
                        </li>
            ...
            <div class="card">
                <div class="card-header" style="background-color:#0e2238;">
                    <div class="d-flex mt-1 p-2">
                        <h3 style="font-weight:bold; color:white;"><i class="lni lni-cog"></i> Audit Log</h3>
                    </div>
                </div>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="d-flex" style="align-items:center; gap: 10px;">
                                <input type="text" name="searchAudit" id="searchAudit" class="d-flex align-items-end rounded" placeholder="Search Audit Log">
                                <div style="width: 150px;">
                                    <label for="">Filter By Action</label>
                                    <select name="filterAudit" id="filterAudit" class="form-select">
    ...
    <script src="./../assets/js/auditlog.js"></script>
