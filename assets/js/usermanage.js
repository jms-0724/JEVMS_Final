...
//    Opens Confirmation window
   ...
   document.getElementById("proceedAdd").addEventListener("click", ()=> {
        ...
        let add_position = document.getElementById("add_position").value;

        add_userfname = capitalizeFirstLetterOfEachWord(add_userfname);
        add_usermname = capitalizeFirstLetterOfEachWord(add_usermname);
        add_userlname = capitalizeFirstLetterOfEachWord(add_userlname);
...
document.getElementById("proceedUpdate").addEventListener("click", ()=> {
    ...
    .then(data => {
        if(data = "Success"){
            ...
            $("#confirmUserUpdate").modal('hide');
            document.getElementById("addUserForm").reset();
            // document.getElementById("textUser").textContent = "User Credentials Successfully Updated";
            display();
        } else if (data = "Failed"){
            $("#failed6").modal('show');
            $("#confirmUserUpdate").modal('hide');
...
document.getElementById("proceedUpdate2").addEventListener("click", ()=> {
    ...
    upd_userfname = capitalizeFirstLetterOfEachWord(upd_userfname);
    upd_usermname = capitalizeFirstLetterOfEachWord(upd_usermname);
    upd_userlname = capitalizeFirstLetterOfEachWord(upd_userlname);
...
dynamicOption();
  ...
  function editUserInfo(uid){
    ...
    .then(data => {
        ...
        document.getElementById("upd_position").value = tbl_user_info.user_position;
