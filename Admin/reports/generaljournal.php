...
// Calculate the height for the MultiCell (description)
$descriptionHeight = $pdf->getStringHeight(75, $row1['description']);

// Adjust the height of the preceding cells to match the description height
$pdf->Cell(20, $descriptionHeight, '', 'LRB', 0, 'C', false); // Empty date cell
$pdf->Cell(20, $descriptionHeight, '', 'LRB', 0, 'C', false); // Empty JEV number cell

// Store current X position before printing the MultiCell
$xBeforeDescription = $pdf->GetX();
$yBeforeDescription = $pdf->GetY();

// Print the MultiCell for description
$pdf->MultiCell(75, $descriptionHeight, $row1['description'], 'LRB', 'L');

// After printing the MultiCell, reset X and adjust for the remaining cells
$pdf->SetXY($xBeforeDescription + 75, $yBeforeDescription);

// Print the remaining cells with the same height
$pdf->Cell(25, $descriptionHeight, '', 'LTRB', 0, 'C', false); // Empty account code
$pdf->Cell(10, $descriptionHeight, '', 'LTRB', 0, 'C', false); // Empty P
$pdf->Cell(20, $descriptionHeight, '', 'LTRB', 0, 'C', false); // Empty debit
$pdf->Cell(20, $descriptionHeight, '', 'LTRB', 1, 'C', false); // Empty credit
